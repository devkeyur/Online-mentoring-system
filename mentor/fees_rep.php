...
$id = $mentor['id'];
$sql = "SELECT * FROM fees_report WHERE mentor_id = '$id'";
...
<div class="w-full min-h-screen font-sans text-gray-900 bg-gray-50 flex">
    ...
    <main class="flex-1">
        ...
        <div class="text-center shadow-md">
            <h2 class="p-2 text-base text-violet-700">Fees Verify</h2>
        </div>
        <div>
            <!-- Table -->
                    ...
                    <table class="w-full text-sm text-center text-gray-500 cursor-pointer">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-300 sticky top-0">
                            <tr class="">
                                ...
                                <th scop="col" class="py-3 px-6">Fees Receipt</th>

                            </tr>
                        </thead>
                        <tbody class="text-xs mt-4 overflow-y-auto h-auto text-center">
                            ...
                            while ($leave_request = mysqli_fetch_assoc($result)) { ?>
                                <tr>
                                    ...
                                    <td><?php echo $leave_request['sem'];
                                        echo '<sup>th</sup>' ?></td>
                                    <td>
                                        <?php $image = $leave_request['filename'];
                                        echo ' <img src="images/fees_report/' . $image . '" width="100px" height="100px" >' ?>
                                    </td>
